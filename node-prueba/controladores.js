...
const URL = "mongodb://root:example@172.19.0.3:27017/"; //url de coneccion a Mongodb
...
controladores.Crear_Usuario = async (req, res) => {
    try {
        ...
        let contraseña_hasheada = await bcrypt.hash(contraseña, 10);
